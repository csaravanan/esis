...
import com.entelience.objects.risk.Group;
import com.entelience.util.DateHelper;

public final class list_005fgroups_jsp extends com.entelience.servlet.JspBase
...
try	{
	...
	Group g = groups[i];
      ...
      out.write("\n\t<tr>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(g.getName()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(g.getDescription()));
      out.write("</td>\n\t</tr>\n\t");
