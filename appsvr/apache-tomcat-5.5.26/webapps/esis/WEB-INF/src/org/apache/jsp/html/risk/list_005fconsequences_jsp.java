...
import com.entelience.objects.risk.Consequence;
import com.entelience.objects.risk.RiskId;
import com.entelience.objects.risk.RiskReviewId;
import com.entelience.objects.risk.RiskImpactId;
import com.entelience.util.DateHelper;

public final class list_005fconsequences_jsp extends com.entelience.servlet.JspBase
...
try	{
	...
	Consequence c = consequences[i];
      ...
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print( c.isBenefic() ? "-" : HTMLEncode(c.getConsequenceLevel()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print( c.isBenefic() ? HTMLEncode(c.getConsequenceLevel()) : "-");
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print( c.isDeleted() ? "yes" : "no");
      out.write("</td>\n\t</tr>\n\t");
