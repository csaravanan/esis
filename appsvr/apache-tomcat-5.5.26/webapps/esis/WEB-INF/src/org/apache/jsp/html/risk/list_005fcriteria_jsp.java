...
public final class list_005fcriteria_jsp extends com.entelience.servlet.JspBase
...
try	{
	...
	Criteria c = criteria[i];
      ...
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getCriteriaDescription()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getCategory()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getExpectedAnswerType()));
      out.write("</td>\n\t</tr>\n\t");
