...
import com.entelience.objects.risk.Action;
import com.entelience.objects.risk.RiskId;
import com.entelience.objects.risk.RiskReviewId;
import com.entelience.objects.risk.RiskControlId;
...
try	{
	...
	Action a = actions[i];
      ...
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(a.getDescription()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(a.getStatus()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(formatDate(a.getTargetDate()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(a.getResponsible()));
      out.write("</td>\n\t</tr>\n\t");
