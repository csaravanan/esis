...
import com.entelience.objects.risk.Cause;
import com.entelience.util.DateHelper;

public final class list_005fcauses_jsp extends com.entelience.servlet.JspBase
...
try	{
	...
	Cause c = causes[i];
      ...
      out.write("\n\t<tr>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getReference()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getTitle()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getDescription()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print( c.getPeriod());
      out.write(" years</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(c.getLikelihood()));
      out.write(' ');
      out.write('(');
      out.print( c.getProbability());
      out.write(")</td>\n\t\t<td align=\"center\">");
      out.print( c.getNumberOfOccurences());
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(formatDate(c.getHorizonStartDate()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(formatDate(c.getHorizonEndDate()));
      out.write("</td>\n\t</tr>\n\t");
