...
import com.entelience.objects.risk.Risk;
import com.entelience.util.DateHelper;

public final class list_005frisks_jsp extends com.entelience.servlet.JspBase
...
try	{
	...
	Risk r = risks[i];
      ...
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(r.getDescription()));
      out.write("</td>\n\t\t<td align=\"center\">");
      ...
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(r.getLikelihood()));
      out.write(' ');
      out.write('(');
      out.print( r.getProbability());
      out.write(")</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(r.getStandardName()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print( r.getNbTopics());
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(formatDate(r.getExpirationDate()));
      out.write("</td>\n\t\t<td align=\"center\">");
      out.print(HTMLEncode(r.getResponsible()));
      out.write("</td>\n\t</tr>\n\t");
