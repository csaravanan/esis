...
public final class inv_005fvulnerabilities_jsp extends com.entelience.servlet.JspBase
...
try{
	...
	//end code
      ...
      out.write("\n<!-- Now begins HTML page ...-->\n<head>\n<title>Investigated vulnerabilities - ");
      ...
      out.write("\n\t\t\t\t<li>\n\t\t\t\t<div align=\"left\"><b>");
      out.print( vulns[i].getVuln_name() );
      out.write("</b> - ");
      out.print( HTMLTitle(vulns[i].getDescription(), null) );
      out.write("<br/>&nbsp;</div>\n\t\t\t\t</li>\n\t\t\t\t");
