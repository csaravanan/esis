...
<%--
  ...
  --
  -- $Id: inv_vulnerabilities.jsp 11 2009-07-07 15:02:53Z tburdairon $
  --
  --%>
...
try{
	...
	VulnerabilityInfoLine[] vulns = vr.getInvestigatedVulnerabilities(order, way, pageNumber, my);
	//end code
%>
<!-- Now begins HTML page ...-->
<head>
<title>Investigated vulnerabilities - <%= todaysDate %></title>
...
<tr>
	<td>
		...
		<tr>
			...
			<td width="80%" align="center" class="title">Investigated vulnerabilities</td>
		</tr>
		<tr>
		...
		<tr>
			<td>
				...
				%>
				<li>
				<div align="left"><b><%= vulns[i].getVuln_name() %></b> - <%= HTMLTitle(vulns[i].getDescription(), null) %><br/>&nbsp;</div>
				</li>
				<%
				}// end for
				%>
