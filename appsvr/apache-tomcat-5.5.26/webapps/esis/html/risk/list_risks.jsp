...
<%--
  ...
  --
  -- $Id: list_risks.jsp 11 2009-07-07 15:02:53Z tburdairon $
  --
  --%>
<%@ page import="com.entelience.soap.soapRiskAssessment" %>
<%@ page import="com.entelience.objects.risk.Risk" %>
...
try	{
	...
	Risk[] risks = ri.listRisks(my, order, way, pageNumber);
	// end code
%>
<!-- Now begins HTML page ...-->
<head>
<title>List of Risks - <%= todayDate %> </title>
...
<tr>
	...
	<tr>
		...
		<td width="80%" align=center class=title>List of Risks</td>
     </tr>
     <tr>
	...
	<tr>
		...
		<td align="center" bgcolor="gainsboro">Review period</td>
		<td align="center" bgcolor="gainsboro">Forced Review</td>
		<td align="center" bgcolor="gainsboro">Likelihood &amp; probability</td>
		<td align="center" bgcolor="gainsboro">Compliant to standard</td>
		<td align="center" bgcolor="gainsboro">Nb of topics</td>
		<td align="center" bgcolor="gainsboro">Expiration date</td>
	...
	<tr>
		...
		<td align="center"><%=HTMLEncode(r.getDescription())%></td>
		<td align="center"><%=HTMLEncode(r.getCategoryName())%></td>
		<td align="center"><%= r.getReviewPeriod()%> days</td>
		<td align="center"><%= r.isForcedReview() ? "yes" : "no"%></td>
		<td align="center"><%=HTMLEncode(r.getLikelihood())%> (<%= r.getProbability()%>)</td>
		<td align="center"><%=HTMLEncode(r.getStandardName())%></td>
		<td align="center"><%= r.getNbTopics()%></td>
		<td align="center"><%=formatDate(r.getExpirationDate())%></td>
		<td align="center"><%=HTMLEncode(r.getResponsible())%></td>
	</tr>
	<%
	} // end for
	%>
