...
<%--
  ...
  --
  -- $Id: interview.jsp 11 2009-07-07 15:02:53Z tburdairon $
  --
  --%>
...
<%@ page import="com.entelience.objects.audit.AuditInterviewId" %>
...
%>
<head>
<title>Interview for audit: <%= ra.getReference() %></title>
...
<tr>
	<td>
		...
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
		<tr>
			<td align="center" class="subtitle">Audit <%= ra.getReference() %></td>
		</tr>
		</table>
		<br/>
		<!-- Interview info -->
